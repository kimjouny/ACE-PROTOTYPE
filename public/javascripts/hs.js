window.onload = function () {
    var show_asset_list = document.getElementById("show_asset_list");
    var pension_asset_lists = document.getElementById("pension_asset_lists");
    show_asset_list.addEventListener("click", show_asset_function);
    function show_asset_function() {
        if (pension_asset_lists.style.display == "none") {
            pension_asset_lists.style.display = "block";
        ...
        else if (pension_asset_lists.style.display == "block") {
            pension_asset_lists.style.display = "none";
        }
    }
